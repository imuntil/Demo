    ...
    var angle = 0,
        ...
        process = function (j) {
            var value = values[j],
                ...
                num = paper.text(cx + (r + delta - 60) * Math.cos(popangle * rad), cy + (r + delta - 50) * Math.sin(popangle * rad), labels[i] + ' : ' + values[i])
