...
TweenMax.to("#section1",easeTime0,{autoAlpha:0,ease:Linear.easeNone,delay:4-easeTime0,onComplete:drawSection2});
}
...
function drawSection2(){
	...
	TweenMax.to("#section2",easeTime,{autoAlpha:1,ease:Linear.easeNone});
	  ...
	  $("#section2").click(function(e) {
		gaEvent("clickgold");
        TweenMax.to("#section2",easeTime,{autoAlpha:0,ease:Linear.easeNone,onComplete:showSection3});
    	});
	  }});
}
...
function showSection3(){
	...
	TweenMax.to("#section3",easeTime,{autoAlpha:1,ease:Linear.easeNone});
	TweenMax.to("#section3 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:easeTime});
  	TweenMax.to("#section3 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2*easeTime});
	TweenMax.to("#section4",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:5*easeTime,onComplete:showSection4});
	TweenMax.delayedCall(5*easeTime,playSectin4Bg);
}
...
function playSectin4Bg(){
	var fps          = 25,
      currentFrame = 0,
      totalFrames  = 10,
      canvas       = document.getElementById("s2"),
      ctx          = canvas.getContext("2d"),
      currentTime  = rightNow();
  ...
  (function animloop1(time){
	...
	img = queue.getResult("quc"+(frameNum+1));
    sequences2 = requestAnimationFrame(animloop1);
	drawFrame(ctx,img,640,1008,frameNum);
    currentTime = time;
  })(currentTime);
}
function showSection4(){
	TweenMax.to("#section3",0,{autoAlpha:0});
	TweenMax.to("#section4 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:easeTime});
  	TweenMax.to("#section4 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2*easeTime});
	TweenMax.to("#section4 .text3",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:3*easeTime});
	TweenMax.to("#section4 .text4",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:4*easeTime,onComplete:function(){
	  $("#section4").click(function(e) {
		gaEvent("clickgrey");
        TweenMax.to("#section5",easeTime,{autoAlpha:1,ease:Linear.easeNone,onComplete:showSection5});
    	});
	  }});
}
/*********************************************
...
function showSection5(){
	...
	//TweenMax.to("#section5 .text4",easeTime,{autoAlpha:1,ease:Linear.easeNone,onComplete:section5Swipe});
	//TweenMax.delayedCall(easeTime*0.5,section5Swipe);
	section5Swipe();
}
...
function section5Swipe(){
	//$$("#section5").swipeLeft(function(){
		  //if(!isToRight){
			  //gaEvent("slideleft");
			  isToRight = true;
			  TweenMax.to("#section5 .text4",easeTime,{autoAlpha:0});
			  TweenMax.to("#section5 .in",2.5,{x:-415,ease:Sine.easeInOut});
			  TweenMax.to("#section5 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2.5});
			  TweenMax.to("#section5 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2.5+easeTime});
			  TweenMax.to("#section5 .text3",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2.5+2*easeTime,onComplete:section5Click});
		  //}
	//});
}
function section5Click(){
        TweenMax.to("#section6",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:easeTime,onComplete:showSection6});
}
...
function showSection6(){
	TweenMax.to("#section5",0,{autoAlpha:0});
	TweenMax.to("#section6 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone});
  	TweenMax.to("#section6 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:1*easeTime});
	TweenMax.to("#section7",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:3*easeTime,onComplete:showSection7});
}
function section6Click(){
	//$("#section6").click(function(e) {
        TweenMax.to("#section7",easeTime,{autoAlpha:1,ease:Linear.easeNone,onComplete:showSection7});
    //});
}
/*********************************************
Secrion7 Action
...
function showSection7(){
	TweenMax.to("#section6",0,{autoAlpha:0});
	TweenMax.to("#section7 .in",2,{x:-290,ease:Sine.easeInOut});
	TweenMax.to("#section7 .text1",easeTime,{autoAlpha:1,delay:2,ease:Linear.easeNone,onComplete:section7Click});
}
function section7Click(){
	$("#section7 .text1").click(function(e) {
		gaEvent("clicktree");
        TweenMax.to("#section8",easeTime,{autoAlpha:1,ease:Linear.easeNone,onComplete:showSection8});
    });
}
...
function showSection8(){
	TweenMax.to("#section7",0,{autoAlpha:0});
	TweenMax.to("#section8 .in",2,{x:-207,y:-310,ease:Sine.easeInOut});
	TweenMax.to("#section8 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2});
  	TweenMax.to("#section8 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:2+1*easeTime});
	TweenMax.to("#section8 .text3",easeTime,{autoAlpha:1,delay:2+2*easeTime,ease:Linear.easeNone,onComplete:section8Click});
}
function section8Click(){
	$("#section8").click(function(e) {
		gaEvent("clicktruffle");
        TweenMax.to("#section9",easeTime,{autoAlpha:1,ease:Linear.easeNone,onComplete:showSection9});
    });
}
...
function showSection9(){
	TweenMax.to("#section8",0,{autoAlpha:0});
	TweenMax.to("#section9 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:0});
  	TweenMax.to("#section9 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:1*easeTime});
	TweenMax.to("#section10",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:3*easeTime,onComplete:showSection10});
}
function section9Click(){
	$("#section9").click(function(e) {
...
function showSection10(){
	TweenMax.to("#section9",0,{autoAlpha:0});
	TweenMax.to("#section10 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:0});
  	TweenMax.to("#section10 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:1*easeTime});
	TweenMax.to("#section11",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:3*easeTime,onComplete:showSection11});
	TweenMax.delayedCall(3*easeTime,playSection11Bg);
	
}
function section10Click(){
	$("#section10").click(function(e) {
        TweenMax.to("#section11",easeTime,{autoAlpha:1,ease:Linear.easeNone,onComplete:showSection11});
    });
}
...
Secrion11 Action
**********************************************/
function playSection11Bg(){
	var fps          = 15,
      currentFrame = 0,
      totalFrames  = 135,
      canvas       = document.getElementById("s4"),
      ctx          = canvas.getContext("2d"),
      currentTime  = rightNow();
  
  (function animloop4(time){
    var delta = (time - currentTime) / 1000;
	if(Math.abs(delta) <1){
		currentFrame += (delta * fps);
	}  
    var frameNum = Math.floor(currentFrame);
    if (frameNum >= totalFrames-15) {
		
		if(!section11IsPlay){
			section11IsPlay = true;
			showSection13();
		}
    }
	if(frameNum == totalFrames){
	...
	img = queue.getResult("qud"+(frameNum+1));
    sequences4 = requestAnimationFrame(animloop4);
	ctx.drawImage(img, 0, 0, 640, 1008, 0, 0, 640, 1008);
    currentTime = time;
  })(currentTime);
}
...
function showSection11(){
	TweenMax.to("#section10",0,{autoAlpha:0});
	TweenMax.to("#section11 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:0});
	TweenMax.to("#section11 .text1",easeTime,{autoAlpha:0,ease:Linear.easeNone,delay:easeTime*2});
	TweenMax.to("#section11 .text3",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:3.4});
	TweenMax.to("#section11 .text3",0.6*easeTime,{autoAlpha:0,ease:Linear.easeNone,delay:5.4});
}
...
function showSection13(){
	...
	TweenMax.to("#section11",1,{autoAlpha:0,ease:Linear.easeNone,onComplete:function(){
		cancelAnimationFrame(sequences4);
		}});
	TweenMax.to("#section13",1.3*easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:1.3*easeTime});
	$("#section14").css({"visibility":"inherit","opacity":1});
	TweenMax.to($("#section13 .star1"), 1, {opacity:1,repeat:-1,ease:Linear.easeNone,yoyo:true});
	TweenMax.to($("#section13 .star2"), 1, {opacity:1,repeat:-1,ease:Linear.easeNone,yoyo:true,delay:easeTime});
	TweenMax.delayedCall(2.6*easeTime,showSection14);
}
...
function showSection14(){
	//cancelAnimationFrame(sequences4);
	//TweenMax.to("#section11",1.5*easeTime,{x:-175,ease:Sine.easeOut,delay:easeTime});
	TweenMax.to("#section14 .text0",easeTime,{autoAlpha:1,ease:Linear.easeNone});
	TweenMax.to("#section14 .text1",easeTime,{autoAlpha:1,ease:Linear.easeNone});
  	TweenMax.to("#section14 .text2",easeTime,{autoAlpha:1,ease:Linear.easeNone});
	TweenMax.to("#section14 .text3",easeTime,{autoAlpha:1,ease:Linear.easeNone});
	
	TweenMax.to("#section14 .text1",easeTime,{autoAlpha:0,ease:Linear.easeNone,delay:2*easeTime});
  	TweenMax.to("#section14 .text2",easeTime,{autoAlpha:0,ease:Linear.easeNone,delay:2*easeTime});
	TweenMax.to("#section14 .text4",easeTime,{autoAlpha:1,ease:Linear.easeNone,delay:3*easeTime});
	
	TweenMax.to("#section14 .text4",easeTime,{autoAlpha:0,ease:Linear.easeNone,delay:7*easeTime,onComplete:function(){
		TweenMax.to("#section15",easeTime,{autoAlpha:1,ease:Linear.easeNone});
		
		}});
	/*TweenMax.delayedCall(6*easeTime+0.8,function(){
		TweenMax.to("#section14",easeTime,{autoAlpha:0,ease:Linear.easeNone});
